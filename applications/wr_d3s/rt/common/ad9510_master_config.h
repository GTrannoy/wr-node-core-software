...
{0x43, 0x03}, //OUT7: WHIST - LVDS OFF
{0x44, 0x13},
{0x45, 0x1D}, //master :select CLK1 input, no PLL, CLK2 PD, REFIN PD
{0x48, 0x00},
{0x49, 0x80},
{0x4A, 0x00}, //OUT1: WHIST - RF_DR_P/N divide by 2 but bypassed below => RF
{0x4B, 0x80}, //OUT1: WHIST - Bypass divider RF_DR_P/N=RF, phase offset=0x0
...
{0x55, 0x00}, //OUT6: WHIST - RF_LV_P/N (Divider not bypassed, 0x80 if bypassed)
{0x56, 0x00},
{0x57, 0x00},
{0x58, 0x21},
{0x59, 0x00},
