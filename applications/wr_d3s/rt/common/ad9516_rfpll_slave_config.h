...
const struct ad95xx_reg ad9516_rfpll_slave_config[] = {
//Serial Port Configuration
{0x0000, 0x18},
{0x0003, 0xC3}, // Read only : 9516-4 version
{0x0004, 0x01}, // Readback active registers
//PLL
{0x0010, 0x7C}, //Polarity POS; CP currrent default, CP mode default, PLL active (ON)
...
{0x0018, 0x06}, //lock detect enabled, vco cal divider default 16
{0x0019, 0x00}, //default
...
{0x00F4, 0x0A}, //OUT4 unused
{0x00F5, 0x0A}, //OUT5 unused, default
//LVDS/CMOS Outputs
{0x0140, 0x43}, //OUT6 unused, Power Down
{0x0141, 0x43}, //OUT7 unused, Power Down
{0x0142, 0x43}, //OUT8 unused, Power Down
{0x0143, 0x42}, //OUT9 LVDS, to RFSync mux
//LVPECL Channel Dividers
{0x0190, 0x00},
{0x0191, 0x80}, //bypass divider: OUT0/OUT1=RF/8*40/5(VCO divider)=RF
{0x0192, 0x00},
{0x0193, 0x00},
{0x0194, 0x80}, //bypass divider: OUT2/OUT3=RF/8*40/5(VCO divider)=RF
{0x0195, 0x00},
{0x0196, 0x00},
{0x0197, 0x80}, //Power Down divider
{0x0198, 0x00},
//LVDS/CMOS Channel Dividers
{0x0199, 0x00},
{0x019A, 0x00},
{0x019B, 0x00},
{0x019C, 0x30}, //Bypass (power down) Divider 3.1 and 3.2
{0x019D, 0x00},
{0x019E, 0x00}, //OUT8/OUT9=RF/8*40/5(VCO divider)=RF
{0x019F, 0x00},
{0x01A0, 0x00},
{0x01A1, 0x30}, //Bypass (power down) Divider 4.1 and 4.2
{0x01A2, 0x00},
//VCO Divider and CLK Input
{0x01E0, 0x03}, //VCO divider = 5
{0x01E1, 0x02}, //Select VCO
//System
{0x0230, 0x00},
